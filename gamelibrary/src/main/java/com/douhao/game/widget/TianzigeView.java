...
public class TianzigeView extends AppCompatTextView {
    ...
    public TianzigeView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TianzigeView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     * @param y
     */
    private void drawTianzige(Canvas canvas, float x, float y, int index) {
        // 设置白色背景
