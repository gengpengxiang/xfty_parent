...
function SiriWave9(opt) {
	...
	this.speed = 0.5;
	this.amplitude = opt.amplitude || 3;

	// Interpolation

	// this.speedInterpolationSpeed = opt.speedInterpolationSpeed || 0.005;
	this.speedInterpolationSpeed = opt.speedInterpolationSpeed || 0.001;
	// this.amplitudeInterpolationSpeed = opt.amplitudeInterpolationSpeed || 0.05;
	this.amplitudeInterpolationSpeed = opt.amplitudeInterpolationSpeed || 2;
