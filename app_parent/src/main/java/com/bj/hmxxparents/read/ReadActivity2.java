...
public class ReadActivity2 extends BaseActivity implements IViewRead, CustomAdapt {
...
//    private PopupWindow mPopupWindow;
    ...
    private CustomPopDialog dialog, dialogSign;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initViews();
        presenter.getReadInfo(student_code, "2");
    ...
    private void initShuomingDialog() {
        CustomPopDialog.Builder dialogBuild = new CustomPopDialog.Builder(ReadActivity2.this);
        ...
        // tvShuoming.setText(getResources().getString(R.string.read_shuoming2));
        ...
        if (PreferencesUtils.getInt(this, "firstread", 0) == 1) {
            ...
            PreferencesUtils.putInt(ReadActivity2.this, "firstread", 1);
        } else {

            layoutCheckbox.setVisibility(View.VISIBLE);

            checkBox.setChecked(false);
            PreferencesUtils.putInt(ReadActivity2.this, "firstread", 0);
        }
        ...
        dialog.findViewById(R.id.bt_close).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (PreferencesUtils.getInt(ReadActivity2.this, "firstread", 0) == 1) {
                    layoutCheckbox.setVisibility(View.GONE);
                    PreferencesUtils.putInt(ReadActivity2.this, "firstread", 1);
                } else {
                    layoutCheckbox.setVisibility(View.VISIBLE);
...
//        offsetX = Math.abs(mPopupWindow.getContentView().getMeasuredWidth() / 2);
        ...
        view.findViewById(R.id.tv_record).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ReadActivity2.this, SignRecordActivity.class);
        ...
        view.findViewById(R.id.bt_confirm).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(etTitle.getText()) && !TextUtils.isEmpty(etNumber.getText())
                    ...
                    T.showShort(ReadActivity2.this, "请补全签到信息");
                }
            }
        });
...
//                    tvCityNames[i].setText(cityList.get(i).getName());
                    ...
                    if (cityList.get(i).getSuo().equals("1")) {
                        ...
                        tvCityNames[i].setBackgroundResource(R.mipmap.ic_flag_blue);
                    } else {
                        ivCityLocks[i].setVisibility(View.VISIBLE);
                        tvCityNames[i].setBackgroundResource(R.mipmap.ic_flag_green);
                    }
    ...
    public void getSignResult(String result) {
        ...
        if (signResult.getRet().equals("1")) {
            T.showShort(ReadActivity2.this, "签到成功");
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.bt_change:
                Intent intent0 = new Intent(ReadActivity2.this,ReadActivity.class);
                intent0.putExtra("yuedudaka_map","2");
            ...
            case R.id.iv_city_photo1:
                if (cityList.get(0).getSuo().equals("1")) {
                    Intent intent1 = new Intent(ReadActivity2.this, ReadDetailActivity.class);
                    intent1.putExtra("code", cityList.get(0).getCode());
                    startActivityForResult(intent1, 1);
                } else {
                    T.showShort(ReadActivity2.this, "集满蜂蜜才会解锁哦！");
                }
                break;
            case R.id.iv_city_photo2:
                if (cityList.get(1).getSuo().equals("1")) {
                    Intent intent2 = new Intent(ReadActivity2.this, ReadDetailActivity.class);
            ...
            case R.id.iv_city_photo3:
                if (cityList.get(2).getSuo().equals("1")) {
                    Intent intent3 = new Intent(ReadActivity2.this, ReadDetailActivity.class);
            ...
            case R.id.iv_city_photo4:
                if (cityList.get(3).getSuo().equals("1")) {
                    Intent intent4 = new Intent(ReadActivity2.this, ReadDetailActivity.class);
            ...
            case R.id.iv_city_photo5:
                if (cityList.get(4).getSuo().equals("1")) {
                    Intent intent5 = new Intent(ReadActivity2.this, ReadDetailActivity.class);
            ...
            case R.id.iv_city_photo6:
                if (cityList.get(5).getSuo().equals("1")) {
                    Intent intent6 = new Intent(ReadActivity2.this, ReadDetailActivity.class);
            ...
            case R.id.iv_city_photo7:
                if (cityList.get(6).getSuo().equals("1")) {
                    Intent intent7 = new Intent(ReadActivity2.this, ReadDetailActivity.class);
            ...
            case R.id.iv_city_photo8:
                if (cityList.get(7).getSuo().equals("1")) {
                    Intent intent8 = new Intent(ReadActivity2.this, ReadDetailActivity.class);
            ...
            case R.id.iv_city_photo9:
                if (cityList.get(8).getSuo().equals("1")) {
                    Intent intent9 = new Intent(ReadActivity2.this, ReadDetailActivity.class);
            ...
            case R.id.iv_city_photo10:
                if (cityList.get(9).getSuo().equals("1")) {
                    Intent intent10 = new Intent(ReadActivity2.this, ReadDetailActivity.class);
            ...
            case R.id.iv_city_photo11:
                if (cityList.get(10).getSuo().equals("1")) {
                    Intent intent11 = new Intent(ReadActivity2.this, ReadDetailActivity.class);
    ...
    private void initPopAddBadgeView() {
        popview = LayoutInflater.from(ReadActivity2.this).inflate(R.layout.pop_read_add_badge, null);
        ...
        popAddBadge.setOnDismissListener(() -> {
            setBackgroundAlpha(ReadActivity2.this, 1f);
        });
    ...
    private void showPopViewAddBadge(String value, Animator.AnimatorListener listener) {
        if (popAddBadge != null && !popAddBadge.isShowing()) {
            setBackgroundAlpha(ReadActivity2.this, 0.5f);
