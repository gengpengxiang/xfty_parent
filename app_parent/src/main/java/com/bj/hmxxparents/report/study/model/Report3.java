...
public class Report3 {
     ...
     * ret : 1
     * msg :
     * data : {"dengji":[{"code":"A","fanwei":{"max":"100","min":"99"}},{"code":"B","fanwei":{"max":"99","min":"85"}},{"code":"C","fanwei":{"max":"85","min":"60"}},{"code":"D","fanwei":{"max":"60","min":"0"}}],"fenxi":[{"exam_code":20180901,"exam_name":"第一次月考","avg_shuxue":"85.38","max_shuxue":"100","shuxue":"0"},{"exam_code":20181109,"exam_name":"第二次月考","avg_shuxue":"92.95","max_shuxue":"100","shuxue":"74"}]}
     */
    ...
    public static class DataBean {
        ...
        public static class FenxiBean {
            ...
            private String avg_shuxue;
            private String max_shuxue;
            ...
            public String getAvg_shuxue() {
                return avg_shuxue;
            }

            public void setAvg_shuxue(String avg_shuxue) {
                this.avg_shuxue = avg_shuxue;
            }

            public String getMax_shuxue() {
                return max_shuxue;
            }

            public void setMax_shuxue(String max_shuxue) {
                this.max_shuxue = max_shuxue;
            }
