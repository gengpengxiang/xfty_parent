package com.bj.hmxxparents.report;
...
import com.bj.hmxxparents.report.fragment.ReportFragment1;
import com.bj.hmxxparents.report.fragment.ReportFragment2;
import com.bj.hmxxparents.report.fragment.ReportFragment3;
import com.bj.hmxxparents.report.fragment.ReportFragment4;
import com.bj.hmxxparents.report.fragment.ReportFragment5;
import com.bj.hmxxparents.report.fragment.ReportFragment6;
import com.bj.hmxxparents.report.fragment.ReportFragment7;
...
public class ReportActivity extends BaseActivity {
    ...
    private void initPopViewShare() {
        ...
        ivShareSession.setOnClickListener(view -> {
            ...
            EventBus.getDefault().post(new MessageEvent("reportShare", "weixin",pageIndex));
            if (popShare != null && popShare.isShowing()) {
                popShare.dismiss();
                return;
            }
        ...
        ivShareTimeline.setOnClickListener(view -> {
            EventBus.getDefault().post(new MessageEvent("reportShare", "pengyouquan",pageIndex));
            if (popShare != null && popShare.isShowing()) {
                popShare.dismiss();
                return;
            }
