    ...
    private void getReportInfo2() {
        Observable.create(new ObservableOnSubscribe<String>() {
            ...
            public void subscribe(ObservableEmitter<String> e) throws Exception {
                OkGo.<String>post(BASE_URL + "jzxuexibaogao/getbg_yuwen")
                    ...
                    public void accept(String s) throws Exception {
                        ...
                        try {
                            ...
                            if (report2.getRet().equals("1")) {
                                ...
                                dataList = report2.getData().getFenxi();
                                dengjiList = report2.getData().getDengji();
...
//                                setChartEvaluationData(report5.getData());
    ...
    private void setChartData() {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            scoreMineList.add(Float.valueOf(dataList.get(i).getYuwen()));
            scoreAverageList.add(Float.valueOf(dataList.get(i).getAvg_yuwen()));
            scoreMaxList.add(Float.valueOf(dataList.get(i).getMax_yuwen()));
        }
