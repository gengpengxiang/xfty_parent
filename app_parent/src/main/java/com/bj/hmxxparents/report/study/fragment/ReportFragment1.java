...
public class ReportFragment1 extends BaseFragment {
    ...
    private List<Report1.DataBean.FenxiBean> dataList = new ArrayList<>();
    private List<Report1.DataBean.DengjiBean> dengjiList = new ArrayList<>();
...
//        xAxis.setValueFormatter(labelFormatter);
    ...
    private void getReportInfo1() {
        Observable.create(new ObservableOnSubscribe<String>() {
            ...
            public void subscribe(ObservableEmitter<String> e) throws Exception {
                OkGo.<String>post(BASE_URL + "jzxuexibaogao/getbg_zongfen")
                        .params("appkey", MLConfig.HTTP_APP_KEY)
                        .params("studentcode", studentId)
                        .params("classcode", classcode)
                        .params("xuexibaogao_yingyustatus", yingyustatus)
                    ...
                    public void accept(String s) throws Exception {
                        ...
                        try {
                            ...
                            if (report1.getRet().equals("1")) {
                                ...
                                dataList = report1.getData().getFenxi();
                                dengjiList = report1.getData().getDengji();
                                setChartBadgeData();
    ...
    private void setChartBadgeData() {

        for (int i = 0; i < dataList.size(); i++) {
            scoreMineList.add(Float.valueOf(dataList.get(i).getZongfen()));
            scoreAverageList.add(Float.valueOf(dataList.get(i).getAvg_zongfen()));
            scoreMaxList.add(Float.valueOf(dataList.get(i).getMax_zongfen()));
        }
...
//        xAxis.setAxisMaximum(count + 0.5f);
        ...
        leftAxis.setAxisMaximum(Float.valueOf(dengjiList.get(0).getFanwei().getMax())+30f);
...
//            set1.setColor(R.color.color_line_blue);
            ...
            set1.setDrawValues(false);//显示坐标点的数据
