...
public class DonationActivity extends BaseActivity {
    ...
    private void initDatas() {
        edtMoney.post(() -> edtMoney.setSelection(edtMoney.getText().toString().length()));
    }
    ...
    private void showShareDialog() {
        ...
        shareDialog.getWindow().findViewById(R.id.iv_shareSession).setOnClickListener(v -> shareToSession());
        shareDialog.getWindow().findViewById(R.id.iv_shareTimeline).setOnClickListener(v -> shareToTimeline());
        shareDialog.getWindow().findViewById(R.id.iv_close).setOnClickListener(v -> shareDialog.dismiss());
    }
