...
/**
 * Created by zz379 on 2017/3/ic_pinde.
 * 专项徽章二级页面
 */
...
public class BadgeProDetailActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        kidId = getIntent().getExtras().getString(MLProperties.BUNDLE_KEY_KID_ID);
        ...
        // set Adatper
        mAdapter = new LatestNewsHomeAdapter(mDataList, getString(R.string.text_desc_empty_news_badge_pro));
...
//                mXRefreshView.setPullLoadEnable(true);
    ...
    private void initData() {
        ...
        MyGetStudentAllNewsTask task3 = new MyGetStudentAllNewsTask();
        task3.execute(kidId, String.valueOf(currentPage));
    }
    ...
    void actionTipsClick() {
        showTipsDialog(getString(R.string.tips_badge_pro));
    }
    ...
    private class MyClassCommendTypeAsyncTask extends AsyncTask<String, Integer, List<SubjectInfo>> {
        ...
        protected List<SubjectInfo> doInBackground(String... params) {
            ...
            try {
                newList = mService.getClassBadgeProTypeFromAPI(kidId);
            } catch (Exception e) {
                e.printStackTrace();
    ...
    private class MyGetStudentAllNewsTask extends AsyncTask<String, Integer, List<ClassNewsInfo>> {
        ...
        protected List<ClassNewsInfo> doInBackground(String... params) {
            ...
            try {
                dataList = mService.getClassBadgeProNewsFromAPI(studentID, badgeProTypeId, pageIndex);
            } catch (Exception e) {
                e.printStackTrace();
                LL.e(e);
                dataList = null;
                ...
                .subscribe(new Observer<String[]>() {
                    ...
                    public void onNext(String[] result) {
                        if (!StringUtils.isEmpty(result[0]) && result[0].equals("1")) {
                            T.showShort(BadgeProDetailActivity.this, "感谢成功");
                            ...
                            T.showShort(BadgeProDetailActivity.this, "感谢失败，请重试");
                        }
                    }
